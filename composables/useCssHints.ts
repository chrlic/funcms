...
export const siteCssHints: CssHintGroup[] = [
  ...
  { label: 'Theme tokens (CSS vars)', hints: [
    { selector: 'var(--color-bg)', element: 'Page background', example: 'background: var(--color-bg)' },
    { selector: 'var(--color-surface)', element: 'Cards / panels background', example: 'background: var(--color-surface)' },
    { selector: 'var(--color-border)', element: 'Borders / dividers', example: 'border-color: var(--color-border)' },
    { selector: 'var(--color-text)', element: 'Body text colour', example: 'color: var(--color-text)' },
    { selector: 'var(--color-text-secondary)', element: 'Muted / secondary text', example: 'color: var(--color-text-secondary)' },
    { selector: 'var(--color-heading)', element: 'Heading colour', example: 'color: var(--color-heading)' },
    { selector: 'var(--color-accent)', element: 'Accent / brand colour', example: 'color: var(--color-accent)' },
    { selector: 'var(--color-accent-fg)', element: 'Text on accent background', example: 'color: var(--color-accent-fg)' },
    { selector: 'var(--font-body)', element: 'Body font stack', example: 'font-family: var(--font-body)' },
    { selector: 'var(--font-heading)', element: 'Heading font stack', example: 'font-family: var(--font-heading)' },
  ]},
  { label: 'Dark mode', hints: [
    { selector: '.dark body', element: 'Body in dark mode', example: 'background: #0f172a; color: #f1f5f9' },
    { selector: '.dark header', element: 'Nav bar in dark mode', example: 'background: #1e1b4b; border-color: #312e81' },
    { selector: '.dark aside', element: 'Sidebar in dark mode', example: 'background: #0f172a' },
    { selector: '.dark h1, .dark h2, .dark h3', element: 'Headings in dark mode', example: 'color: #e2e8f0' },
    { selector: '.dark a', element: 'Links in dark mode', example: 'color: #818cf8' },
    { selector: '.dark .my-card', element: 'Custom element in dark mode', example: 'background: #1e293b; border-color: #334155' },
  ]},
  { label: 'Colours', hints: [
